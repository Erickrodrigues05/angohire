...
export const PaymentPage = () => {
    ...
    useEffect(() => {
        ...
        if (orderId) {
            fetch(API_ENDPOINTS.ORDERS.GET(orderId))
                .then(res => res.json())
                .then(data => {
                    if (data.success) {
    ...
    const isFree = orderData?.package === 'basic';
            ...
            <div className="max-w-3xl mx-auto px-4">
                ...
                >
                    <h1 className="text-4xl font-bold mb-4">
                        {isFree ? 'Pedido Confirmado! 🎉' : 'Pedido Criado com Sucesso! 🎉'}
                    </h1>
                    <p className="text-gray-400 text-lg">
                        {isFree
                            ? 'O teu Currículo Básico está a ser gerado e será enviado em breve.'
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="text-2xl font-bold text-primary">
                                    {isFree ? 'Grátis' : `${orderData.price?.toLocaleString()} Kz`}
                                </span>
                            </div>
                            <div className="flex justify-between">
